...
namespace Muuvis.Catalog.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddEntityFrameworkRepositories(o => o.UseSqlServer(Configuration.GetConnectionString("Muuvis")));
            services.AddEntityFrameworkDataAccessObjects();

            services.AddServiceBus(r => r
                .AddCatalogQueue()
                .AddCatalogCommands()
                .AddCatalogCommandHandlers());
